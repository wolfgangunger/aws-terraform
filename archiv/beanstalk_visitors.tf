resource "aws_elastic_beanstalk_environment" "visitors_area" {
  application         = aws_elastic_beanstalk_application.this.name
  cname_prefix        = "${var.project}-${var.environment}-visitors"
  description         = "Beanstalk environment for visitors area."
  name                = "${var.project}-${var.environment}-visitors"
  ...
  setting {
    ...
    value     = aws_cognito_user_pool_client.visitors_area_webapi.id
  }
  setting {
    namespace = "aws:elasticbeanstalk:application:environment"
  ...
  setting {
    ...
    value     = "https://${var.urls["visitors"]}/aws/auth/password-reset/reset"
  }
  setting {
    namespace = "aws:elasticbeanstalk:application:environment"
    name      = "ClientConfiguration__SignUpConfirmUrl"
    value     = "https://${var.urls["visitors"]}/aws/auth/sign-up-confirm"
  }
  setting {
    namespace = "aws:elasticbeanstalk:application:environment"
